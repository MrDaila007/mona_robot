...
На диаграмме ниже показано, как `safety_node` (управляемый узел) фильтрует команды управления перед отправкой их на приводы робота.
![ROS 2 Node Graph Architecture](images/node_graph_architecture.png)
## 1. Концепция
