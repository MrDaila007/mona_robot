...
All technical documentation lives in the `docs/en` directory (English version).

| **Document**                                         | **Audience**     | **Description**                                               |
| ---------------------------------------------------- | ---------------- | ------------------------------------------------------------- |
| **[01_SETUP.md](docs/en/01_SETUP.md)**              | DevOps           | Environment setup, Docker, networking and hardware access.    |
| **[02_CPP_GUIDE.md](docs/en/02_CPP_GUIDE.md)**      | C++ Developers   | C++ coding standards, node templates and CMake patterns.      |
| **[03_SAFETY_AND_FDIR.md](docs/en/03_SAFETY_AND_FDIR.md)** | Architects | Safety pipeline, FDIR, E‑Stop logic.                          |
| **[04_WORKFLOW.md](docs/en/04_WORKFLOW.md)**        | All developers   | Build, testing and CI workflow.                               |
| **[CONTRIBUTING.md](docs/en/CONTRIBUTING.md)**      | Contributors     | Git Flow, fault injection testing and pull request process.   |
